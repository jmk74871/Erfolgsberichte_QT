...
class Ui_Erfolgsberichte(object):
    def setupUi(self, Erfolgsberichte):
        ...
        self.tabel_erfolge.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.tabel_erfolge.setAlternatingRowColors(True)
        self.tabel_erfolge.setSelectionMode(QtWidgets.QAbstractItemView.SingleSelection)
        self.tabel_erfolge.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        ...
        self.gridLayout_2.addWidget(self.tabel_erfolge, 10, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.mw_cr_from_date, 1, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.mw_cr_cat_box, 2, 2, 1, 1)
        self.mw_cr_button = QtWidgets.QPushButton(self.centralwidget)
        self.mw_cr_button.setObjectName("mw_cr_button")
        self.gridLayout.addWidget(self.mw_cr_button, 1, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.mw_cr_to_date, 2, 1, 1, 1)
        self.mw_cr_from_label = QtWidgets.QLabel(self.centralwidget)
        self.mw_cr_from_label.setObjectName("mw_cr_from_label")
        self.gridLayout.addWidget(self.mw_cr_from_label, 1, 0, 1, 1)
        self.gridLayout_2.addLayout(self.gridLayout, 4, 0, 1, 1)
        self.mw_edit_button = QtWidgets.QPushButton(self.centralwidget)
        self.mw_edit_button.setEnabled(True)
        self.mw_edit_button.setObjectName("mw_edit_button")
        self.gridLayout_2.addWidget(self.mw_edit_button, 8, 0, 1, 1)
        ...
        self.mw_button_save_edit = QtWidgets.QPushButton(self.centralwidget)
        self.mw_button_save_edit.setObjectName("mw_button_save_edit")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.mw_button_save_edit)
        ...
        self.gridLayout_2.addLayout(self.verticalLayout_2, 11, 0, 1, 1)
        self.mw_delete_button = QtWidgets.QPushButton(self.centralwidget)
        self.mw_delete_button.setEnabled(True)
        self.mw_delete_button.setObjectName("mw_delete_button")
        self.gridLayout_2.addWidget(self.mw_delete_button, 9, 0, 1, 1)
        ...
        self.tabel_erfolge.doubleClicked['QModelIndex'].connect(self.mw_edit_button.show)
        self.tabel_erfolge.doubleClicked['QModelIndex'].connect(self.mw_delete_button.show)
    ...
    def retranslateUi(self, Erfolgsberichte):
        ...
        self.mw_edit_button.setText(_translate("Erfolgsberichte", "Bearbeiten"))
        ...
        self.mw_button_save_edit.setText(_translate("Erfolgsberichte", "Änderungen übernehmen"))
        ...
        self.mw_delete_button.setText(_translate("Erfolgsberichte", "Löschen"))
